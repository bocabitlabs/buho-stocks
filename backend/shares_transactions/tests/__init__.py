...
def create_first_shares_transaction(company: Company):
...
def create_second_shares_transaction(company: Company):
...
def create_third_shares_transaction(company: Company):
...
def create_first_shares_sales_transaction(company: Company):
...
def create_second_shares_sales_transaction(company: Company):

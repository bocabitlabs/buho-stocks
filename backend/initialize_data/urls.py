...
urlpatterns = [
    ...
    path("benchmarks/", views.InitializeBenchmarksView.as_view(), name="initialize_benchmarks"),
    path("sectors/", views.InitializeSectorsView.as_view(), name="initialize_sectors"),
    path("currencies/", views.InitializeCurrenciesView.as_view(), name="initialize_currencies"),
]

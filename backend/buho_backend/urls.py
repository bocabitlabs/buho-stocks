...
urlpatterns = [
    ...
    path("api/v1/companies/<int:company_id>/stock-prices/", include("stock_prices.urls"), name="stocks-prices"),
    ...
    path("api/v1/portfolios/<int:portfolio_id>/messages/", include("log_messages.urls"), name="log-messages"),
    path("api/v1/portfolios/<int:portfolio_id>/companies/", include("companies.urls"), name="companies"),
